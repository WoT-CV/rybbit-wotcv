...
WHERE has_pricing = 1`,
  },
  {
    ...
    description:
      "Użytkownicy, których pierwszy przedział aktywności mieści się w wybranym zakresie, względem późniejszych przedziałów z tego zakresu.",
    category: "Zachowanie",
    beyondPrebuilt: true,
    vizType: "line",
...
LIMIT 50`,
  },
  {
    ...
    description:
      "Sesje według strony wejścia i tego, czy wywołały wybrane zdarzenie własne. Dostosuj event_name do celu.",
    category: "Zachowanie",
    beyondPrebuilt: true,
    vizType: "table",
    mapping: {},
...
LIMIT 50`,
  },
  {
    ...
    description:
      "Udział sesji, które wywołały wybrane zdarzenie własne w każdym przedziale. Dostosuj event_name do celu.",
    category: "Zachowanie",
    beyondPrebuilt: true,
    vizType: "line",
...
LIMIT 50`,
  },
  {
    ...
    description:
      "Podziel wybrane zdarzenie własne według wybranej właściwości. Dostosuj event_name i klucz właściwości.",
    category: "Zdarzenia",
    beyondPrebuilt: true,
    vizType: "bar",
...
ORDER BY events DESC`,
  },
  {
    ...
    description:
      "Mediana i p90 sekund od pierwszej odsłony do wybranego zdarzenia własnego. Dostosuj event_name do celu.",
    category: "Zaawansowane",
    beyondPrebuilt: true,
    vizType: "table",
    mapping: {},
...
ORDER BY width_bucket_start`,
  },
  {
    ...
    description:
      "Sesje podobne do botów lub zaszumione, z wieloma zdarzeniami na minutę, tylko na danych scoped_events.",
    category: "Zaawansowane",
    beyondPrebuilt: true,
    vizType: "table",
    mapping: {},
