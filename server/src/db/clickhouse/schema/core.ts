...
export async function initializeCoreTables() {
  ...
  // Uptime is intentionally retained by the WoT-CV fork. Keep its historical
  // measurements in the same initialization path while replay v1 and v2
  // coexist during the controlled rollout.
  await execClickhouseInitStep(
