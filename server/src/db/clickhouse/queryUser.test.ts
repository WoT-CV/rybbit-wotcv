...
describe("buildQueryUserStatements", () => {
  it("never provisions or revokes grants from the main or default user", () => {
    expect(() => buildQueryUserStatements("analytics", "frog", "x", "frog")).toThrow("separate");
    expect(() => buildQueryUserStatements("analytics", "default", "x", "frog")).toThrow("separate");
    expect(() => buildQueryUserStatements("analytics", "rybbit_query", "x", "frog")).not.toThrow();
  });
